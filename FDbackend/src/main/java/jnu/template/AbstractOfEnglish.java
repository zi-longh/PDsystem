...
/**
 * 论文"英文摘要"的模板规范，会提供默认要求。
 * 包括摘要上方的标题规范要求，摘要的段落规范要求，摘要下方的关键词规范要求。
 * */
public class AbstractOfEnglish {
    public static final String contentName = "英文摘要"; // 标识本类描述的论文内容的名称。
    public static final String markWord1 = "Abstract："; // 标记摘要位置
    /* 开始位置需要靠论文标题来定位 */
    public static final String markWord2 = "Keywords："; // 标记关键词的位置。
     ...
     * 工厂方法，提供默认的中文摘要的规范要求。
     * */
    public static AbstractOfEnglish getDefaultInstance() {
        return new AbstractOfEnglish(
                "宋体",
                1,
                300,
                5,
